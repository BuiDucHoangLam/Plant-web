              ...
              <div className="row marginii">
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 l-12">
                  <div className="carousel-caption ">
                    <h1>
                      {t("welcome")}{" "}
                      <strong className="color">Plants Dalat</strong>
                    </h1>
                    <p>{t("info1")}</p>

                    <a
                      className="btn btn-lg btn-md btn-primary"
                      href="/about"
                      role="button"
                    >
                      {t("about")}
                ...
                <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12 l-12">
                  <div className="img-box">
                    <figure className="circleexam">
                      <img src={gyufyufyu} alt="img" />
                    </figure>
                  </div>
                </div>
              </div>
            ...
            Object.values(species[3].images).flat()[0].url && (
              <div className="row">
                ...
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12 thumb l-6">
                  <div className="Gallery-box Gallery_g">
                    <figure>
                      <img src={Tree2} className="zoom img-fluid " alt="" />
                ...
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12 thumb l-6">
                  <div className="Gallery-box Gallery_g">
                    <figure>
                      <img src={Tree3} className="zoom img-fluid " alt="" />
                ...
                <div className="col-xl-3 col-lg-3 col-md-3 col-sm-12 thumb l-6">
                  <div className="Gallery-box Gallery_g">
                    <figure>
                      <img src={Tree4} className="zoom img-fluid " alt="" />

...
const SpecieEditForm = ({ handleChange, handleSubmit, values, handleFamiliaChange, handleRowRemoveClick,
  showGenus, genusOptions, handleOrdoChange, familiaOptions, showFamilia, handleRowChange,
  handleSynonymsChange, coordinates, ordoList, handleAddCoord, handleRowAddClick }) => {

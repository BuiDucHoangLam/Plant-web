...
const SpecieCreateForm = ({ handleChange, handleSubmit, values, handleRowAddClick,
  handleFamiliaChange, showGenus, genusOptions, handleOrdoChange, handleRowChange, coordinates,
  familiaOptions, showFamilia, handleSynonymsChange, handleDeleteRow, handleRowRemoveClick,
        ...
        <div className="form-group coord-form">
          ...
          {/* <div className="row">
            ...
            <div className="mt-1 col-md-2 l-2">
              <div className="btn btn-outline-info" id='deleteRow' onClick={handleDeleteRow} > Xóa </div>
            </div>
          </div>
          <div id='add-field' style={{ display: 'flex', justifyContent: 'space-between' }}>
            <div className="btn btn-outline-info" id='addCoord' onClick={handleAddCoord} > Thêm </div>
          </div> */}
        </div>
            ...
            <div className="row" key={i}>
              ...
              <div className="mt-1 col-md-2 l-2">
                <div className="btn-box">
                  {coordinates.length !== 1 && <button
                    className="btn btn-outline-danger"
                    onClick={() => handleRowRemoveClick(i)}>Xóa</button>}
              ...
              {coordinates.length - 1 === i && <>
                <br />
                <div id='add-field' style={{ display: 'flex', justifyContent: 'space-between' }}>
                  <div className="btn btn-outline-info" id='addCoord' onClick={handleRowAddClick} > Thêm </div>
                </div>
              </>
              }
            </div>
